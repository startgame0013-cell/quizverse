...
export const STUDY_ENTRIES = [
  ...
  {
    id: 'english-g2-sem1-unit1-summary',
    subjectId: 'english',
    gradeId: 'G2',
    unitId: 'my-school-day',
    unitTitleEn: 'Semester 1 - Unit 1',
    unitTitleAr: 'الفصل الأول - الوحدة الأولى',
    type: 'summary',
    titleEn: 'My School Day',
    titleAr: 'يومي المدرسي',
    descriptionEn: 'Grade 2 English, semester 1. Daily routines, school rooms, action verbs, time, and demonstratives.',
    descriptionAr: 'إنجليزي الصف الثاني، الفصل الأول. الروتين اليومي، مرافق المدرسة، أفعال الحركة، الوقت، وأسماء الإشارة.',
    bodyEn:
      'Source: Skyline English For Kuwait (2-A), Grade 2, Semester 1, Student’s Book.\n\nUnit focus:\n- Phonics: sh /ʃ/, bl /bl/, br /br/\n- Reading and vocabulary: daily routines, action verbs, school rooms, and target sound words\n- Grammar: singular and plural with is/are, demonstrative pronouns these and those\n- Listening and speaking: recognising time, talking about daily routines, asking and answering questions about school\n- Writing: tracing and copying, reordering sentences, completing sentences, writing letters and words, punctuation rules\n\nTeaching note:\nThis unit covers the first four weeks, with 2 days allocated for adjustment.',
    bodyAr:
      'المصدر: Skyline English For Kuwait (2-A) - الصف الثاني - الفصل الأول - Student’s Book.\n\nمحاور الوحدة:\n- الأصوات: sh /ʃ/ و bl /bl/ و br /br/\n- القراءة والمفردات: الروتين اليومي، أفعال الحركة، مرافق المدرسة، وكلمات الأصوات المستهدفة\n- القواعد: المفرد والجمع باستخدام is و are، وأسماء الإشارة these و those\n- الاستماع والتحدث: التعرف على الوقت، الحديث عن الروتين اليومي، وطرح الأسئلة والإجابة عنها حول المدرسة\n- الكتابة: التتبع والنسخ، إعادة ترتيب الجمل، إكمال الجمل، كتابة الحروف والكلمات، وقواعد الترقيم\n\nملاحظة تدريسية:\nتمتد هذه الوحدة خلال الأسابيع الأربعة الأولى، مع تخصيص يومين للتهيئة.',
    tags: ['english', 'grade2', 'semester1', 'unit1', 'school'],
    updatedAt: '2026-03',
  },
  {
    id: 'english-g2-sem1-unit2-summary',
    subjectId: 'english',
    gradeId: 'G2',
    unitId: 'my-home',
    unitTitleEn: 'Semester 1 - Unit 2',
    ...
    titleEn: 'My Home',
    titleAr: 'منزلي',
    descriptionEn: 'Grade 2 English, semester 1. Rooms, positions, permission, family routines, and numbers 40-50.',
    descriptionAr: 'إنجليزي الصف الثاني، الفصل الأول. الغرف، المواقع، طلب الإذن، الروتين العائلي، والأرقام ٤٠-٥٠.',
    bodyEn:
      'Source: Skyline English For Kuwait (2-A), Grade 2, Semester 1, Student’s Book.\n\nUnit focus:\n- Phonics: ou /aʊ/, oy /ɔɪ/\n- Reading and vocabulary: rooms, numbers, antonyms, and target sound words\n- Grammar: present simple with Where is / are, singular and plural nouns, past tense, modal verb can in yes/no questions, prepositions of place on/in/under\n- Listening and speaking: asking for and giving information, asking and answering questions about locations and positions, asking for permission, talking about family routines, counting from 40 to 50, identifying rooms\n- Writing: tracing and copying, reordering sentences, completing sentences, labelling rooms, writing missing numbers\n\nTeaching note:\nThis unit covers weeks 5 to 8.',
    bodyAr:
      'المصدر: Skyline English For Kuwait (2-A) - الصف الثاني - الفصل الأول - Student’s Book.\n\nمحاور الوحدة:\n- الأصوات: ou /aʊ/ و oy /ɔɪ/\n- القراءة والمفردات: الغرف، الأرقام، الأضداد، وكلمات الأصوات المستهدفة\n- القواعد: المضارع البسيط مع Where is / are، الاسم المفرد والجمع، الماضي، الفعل الناقص can في أسئلة نعم/لا، وحروف الجر للمكان on و in و under\n- الاستماع والتحدث: طلب المعلومات وإعطاؤها، السؤال والإجابة عن المواقع والأماكن، طلب الإذن، الحديث عن الروتين العائلي، العد من ٤٠ إلى ٥٠، وتحديد الغرف\n- الكتابة: التتبع والنسخ، إعادة ترتيب الجمل، إكمال الجمل، تسمية غرف المنزل، وكتابة الأرقام الناقصة\n\nملاحظة تدريسية:\nتمتد هذه الوحدة من الأسبوع الخامس إلى الأسبوع الثامن.',
    tags: ['english', 'grade2', 'semester1', 'unit2', 'home'],
    updatedAt: '2026-03',
  },
  {
    id: 'english-g2-sem1-unit3-summary',
    subjectId: 'english',
    gradeId: 'G2',
    unitId: 'all-about-animals',
    unitTitleEn: 'Semester 1 - Unit 3',
    unitTitleAr: 'الفصل الأول - الوحدة الثالثة',
    type: 'summary',
    titleEn: 'All About Animals',
    titleAr: 'كل شيء عن الحيوانات',
    descriptionEn: 'Grade 2 English, semester 1. Animals, actions, present simple, and present continuous.',
    descriptionAr: 'إنجليزي الصف الثاني، الفصل الأول. الحيوانات، الأفعال، المضارع البسيط، والمضارع المستمر.',
    bodyEn:
      'Source: Skyline English For Kuwait (2-A), Grade 2, Semester 1, Student’s Book.\n\nUnit focus:\n- Phonics: ar /ɑː/, or /ɔː/, ir /ɑː/ and /ɜː/\n- Reading and vocabulary: animals, actions, places, and target sound words\n- Grammar: present simple and present continuous\n- Listening and speaking: asking for and giving information, describing animals, describing actions\n- Writing: tracing and copying, reordering sentences, completing sentences, writing missing letters, punctuation rules\n\nTeaching note:\nThis unit runs from weeks 9 to 11.',
    bodyAr:
      'المصدر: Skyline English For Kuwait (2-A) - الصف الثاني - الفصل الأول - Student’s Book.\n\nمحاور الوحدة:\n- الأصوات: ar /ɑː/ و or /ɔː/ و ir /ɑː/ أو /ɜː/\n- القراءة والمفردات: الحيوانات، الأفعال، الأماكن، وكلمات الأصوات المستهدفة\n- القواعد: المضارع البسيط والمضارع المستمر\n- الاستماع والتحدث: طلب المعلومات وإعطاؤها، وصف الحيوانات، ووصف الأفعال\n- الكتابة: التتبع والنسخ، إعادة ترتيب الجمل، إكمال الجمل، كتابة الحروف الناقصة، وقواعد الترقيم\n\nملاحظة تدريسية:\nتمتد هذه الوحدة من الأسبوع التاسع إلى الأسبوع الحادي عشر.',
    tags: ['english', 'grade2', 'semester1', 'unit3', 'animals'],
    updatedAt: '2026-03',
  },
  {
    id: 'english-g2-sem1-unit4-summary',
    subjectId: 'english',
    gradeId: 'G2',
    unitId: 'i-like-sports',
    unitTitleEn: 'Semester 1 - Unit 4',
    unitTitleAr: 'الفصل الأول - الوحدة الرابعة',
    type: 'summary',
    titleEn: 'I Like Sports',
    titleAr: 'أنا أحب الرياضة',
    descriptionEn: 'Grade 2 English, semester 1. Sports, likes and dislikes, can for ability, and action description.',
    descriptionAr: 'إنجليزي الصف الثاني، الفصل الأول. الرياضات، الإعجاب وعدم الإعجاب، can للقدرة، ووصف الأنشطة.',
    bodyEn:
      'Source: Skyline English For Kuwait (2-A), Grade 2, Semester 1, Student’s Book.\n\nUnit focus:\n- Phonics: ay /eɪ/, th /ð/\n- Reading and vocabulary: sports, actions, places, and target sound words\n- Grammar: like + gerund, modal verb can for ability\n- Listening and speaking: expressing likes and dislikes, asking for and giving information, describing actions and sports\n- Writing: tracing and copying simple sentences and numbers, reordering sentences and letters, completing sentences, writing missing numbers, spelling with -ing, punctuation rules\n\nTeaching note:\nThis unit covers weeks 12 to 15. The total number of periods in the semester is 60.',
    bodyAr:
      'المصدر: Skyline English For Kuwait (2-A) - الصف الثاني - الفصل الأول - Student’s Book.\n\nمحاور الوحدة:\n- الأصوات: ay /eɪ/ و th /ð/\n- القراءة والمفردات: الرياضات، الأفعال، الأماكن، وكلمات الأصوات المستهدفة\n- القواعد: like + gerund، والفعل الناقص can للتعبير عن القدرة\n- الاستماع والتحدث: التعبير عن الإعجاب وعدم الإعجاب، طلب المعلومات وإعطاؤها، ووصف الأنشطة والرياضات\n- الكتابة: تتبع ونسخ الجمل البسيطة والأرقام، إعادة ترتيب الجمل والحروف، إكمال الجمل، كتابة الأرقام الناقصة، والتهجئة بإضافة ing، وقواعد الترقيم\n\nملاحظة تدريسية:\nتمتد هذه الوحدة من الأسبوع الثاني عشر إلى الخامس عشر، وإجمالي حصص الفصل الدراسي ٦٠ حصة.',
    tags: ['english', 'grade2', 'semester1', 'unit4', 'sports'],
    updatedAt: '2026-03',
  },
  {
